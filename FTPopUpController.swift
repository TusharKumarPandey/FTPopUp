//
//  TKPopUpController.swift
//  TKPopUp
//
//  Created by Tushar Pandey on 28/05/21.
//
...
public protocol PopupViewControllerDelegate: class {
    ...
    func popupViewControllerDidDismissByTapGesture(_ sender: FTPopUpController)
}
...
@available(iOS 13.0, *)
open class FTPopUpController: UIViewController {
...
@available(iOS 13.0, *)
extension FTPopUpController: UIGestureRecognizerDelegate {
